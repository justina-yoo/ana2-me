...
export default function Privacy({ lang }) {
  ...
  const sections = [
    ...
    {
      heading: '6. Product Reviews',
      headingKo: '6. 제품 리뷰',
      body: 'You may submit product reviews on this site. Reviews are stored in our database and include only the information you provide: a display name (optional, defaults to "Anonymous"), a star rating, and review text. We do not collect your email, IP address, or any other personal data when you submit a review. Review text is filtered for explicit language before being saved. We reserve the right to remove any review at our discretion.',
      bodyKo: '이 사이트에서 제품 리뷰를 작성할 수 있어요. 리뷰는 작성 시 입력한 정보만 저장됩니다: 표시 이름(선택, 기본값 "익명"), 별점, 리뷰 내용. 리뷰 작성 시 이메일, IP 주소 등 개인 데이터는 수집하지 않아요. 리뷰 내용은 저장 전에 부적절한 표현이 필터링됩니다. 저희는 재량에 따라 리뷰를 삭제할 권리를 가집니다.',
    },
    {
    ...
    {
      heading: '10. Content Disclaimer',
      headingKo: '10. 콘텐츠 면책 조항',
    ...
    {
      heading: '11. DMCA / Copyright',
      headingKo: '11. 저작권 및 DMCA',
