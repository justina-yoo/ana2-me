      ...
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        {(() => {
          ...
          while (i < visiblePosts.length) {
            ...
            // Insert cycling analyzer CTA every INTERVAL articles (skip during search/filter)
            if (!query && !activeTag && CTA.shouldInsert(i)) {
              cards.push(CTA.render(ctaCount, t, goAnalyzer));
              ctaCount++;
            }
  ...
  return (
    <div className="detail" style={{ maxWidth: 780, margin: '0 auto' }}>
      ...
      <article ref={articleRef}>
        ...
        {/* Coupang carousel — all Korean articles */}
        {isKo && (
          <div style={{ margin: '40px 0' }}>
            ...
            <div style={{ padding: 20, background: '#fff', border: '1px solid var(--line)', borderRadius: 'var(--radius)' }}>
              ...
              <div ref={(el) => {
                ...
                script.onload = () => {
                  try { new window.PartnersCoupang.G({ id: 1028190, trackingCode: 'AF3626307', subId: null, template: 'carousel', width: '680', height: '140' }); } catch(e) {}
                };
